...
def run_npm_build():
    ...
    if os.path.exists(os.path.join(root, "package.json")):
        ...
        with open(os.path.join(root, "python", "labextension", "install.json"), "w") as fd:
            install_json = {
                "__comment": "metadata about the chemiscope lab extension installation",
                "packageManager": "python",
                "packageName": "chemiscope",
                "uninstallInstructions": "Use your Python package manager (pip, conda, etc.) to uninstall chemiscope"
            }
        ...
        data_files=[
            ...
            (
                ...
                [
                    ...
                    "python/jupyter/nbextension/chemiscope-widget.min.js",
                ],
            ),
            ...
            (
                ...
                list(filter(lambda f: os.path.isfile(f), glob.glob("python/labextension/*"))),
            ),
            (
                "share/jupyter/labextensions/chemiscope/static",
                glob.glob("python/labextension/static/*"),
            ),
        ],
    )
